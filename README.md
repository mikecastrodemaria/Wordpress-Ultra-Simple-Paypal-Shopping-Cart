...
<a href="https://www.youtube.com/watch?v=Td_maZktJ1c" target="_blank">Tutoriel 1</a>

<a href="https://www.youtube.com/watch?v=SKkWHm3wo3E" target="_blank">Tutoriel 2</a>

These are old videos, but still useful

For support and updates, please visit <a href="https://wordpress.org/support/plugin/wp-ultra-simple-paypal-shopping-cart/" target="_blank" title="go to WordPress Ultra Simple Paypal Shopping Cart forum">WordPress Ultra Simple Paypal Shopping Cart Support Forum</a>
...
Copyright 2011-2014 by Mike Castro Demaria & Supersonique Studio Team
...
### Changelog — WP Ultra Simple PayPal Shopping Cart

More changelog can be found at the [Supersonique Studio forum](http://www.supersonique-studio.com)
...
#### = V4.5.3 =
- Enhancement : compatibility with php 8 and code cleaning (thanks MaitreyaLeLion)  
...
Always backup your WP before any upgrade. After the upgrade it's too late.  
