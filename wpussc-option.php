...
add_option('wpus_form_include_email', '1');
add_option('wpus_form_include_phone', '1');
add_option('wpus_form_include_address', '1');
add_option('wpus_form_include_message', '1');
...
function show_wp_cart_options_page()
{
	...
	if (empty($itemQtyString))
		$itemQtyString = __("%d item%s in your cart", "wp-ultra-simple-paypal-shopping-cart");
	$noItemInCartString = get_option('no_item_in_cart_string');
	if (empty($noItemInCartString))
		$noItemInCartString = __("Cart empty", "wp-ultra-simple-paypal-shopping-cart");
	...
	$wpus_form_include_email = (get_option('wpus_form_include_email')) ? 'checked="checked"' : '';
	$wpus_form_include_phone = (get_option('wpus_form_include_phone')) ? 'checked="checked"' : '';
	$wpus_form_include_address = (get_option('wpus_form_include_address')) ? 'checked="checked"' : '';
	$wpus_form_include_message = (get_option('wpus_form_include_message')) ? 'checked="checked"' : '';
...
<div id="tabs">
    <ul>
        <li><a href="#tabs-3"><span
                    class="showme"><?php _e("Do you like WUSPSC ?", "wp-ultra-simple-paypal-shopping-cart"); ?></span></a>
        </li>
    ...
    <div id="tabs-1">
        <h2>
            ...
            <?php _e("WP Ultra Simple Shopping Cart Usage", "wp-ultra-simple-paypal-shopping-cart"); ?> v
            <?php echo WUSPSC_VERSION; ?>
        </h2>
        <p><?php _e("For information, updates and detailed documentation, please visit:", "wp-ultra-simple-paypal-shopping-cart"); ?>
            <a href="https://www.ultra-prod.com/?p=86">ultra-prod.com</a>
        </p>
        <p><?php _e("For support, please use our dedicated forum:", "wp-ultra-simple-paypal-shopping-cart"); ?> <a
                href="https://www.ultra-prod.com/developpement-support/"><?php _e("WPUSPSC Support Forum", "wp-ultra-simple-paypal-shopping-cart"); ?></a>
        </p>

        <fieldset class="options">
            <p>
            <h4><a
                    href="https://www.paypal.com/fr/mrb/pal=CH4PZVAK2GJAJ"><?php _e("1. create a PayPal account (no cost for basic account)", "wp-ultra-simple-paypal-shopping-cart"); ?></a>
            </h4>

            <p>
            <h4><?php _e("2. Create post or page presenting the product or service and add caddy shortcode in the post. See example and possibilities following:", "wp-ultra-simple-paypal-shopping-cart"); ?>
            </h4>
            <ul>
                <ol>
                    ...
                    <blockquote><?php _e("eg.", "wp-ultra-simple-paypal-shopping-cart"); ?>
                        [wp_cart:<?php _e("Test Product", "wp-ultra-simple-paypal-shopping-cart"); ?>:price:15.00:end]
                    </blockquote>
                </ol>
                ...
                <ol>
                    ...
                    <blockquote><?php _e("eg.", "wp-ultra-simple-paypal-shopping-cart"); ?>
                        [wp_cart:<?php _e("Test Product", "wp-ultra-simple-paypal-shopping-cart"); ?>:price:[<?php _e("Size|Small,1.10|Medium,2.10|Large,3.10", "wp-ultra-simple-paypal-shopping-cart"); ?>]:end]
                    </blockquote>
                </ol>
                ...
                <ol>
                    ...
                    <blockquote><?php _e("eg.", "wp-ultra-simple-paypal-shopping-cart"); ?>
                        [wp_cart:<?php _e("Test Product", "wp-ultra-simple-paypal-shopping-cart"); ?>:price:[<?php _e("Size|Small,1.10|Medium,2.10|Large,3.10", "wp-ultra-simple-paypal-shopping-cart"); ?>]:shipping:[<?php _e("Shipping|normal,6.50|fast,10.00", "wp-ultra-simple-paypal-shopping-cart"); ?>]:end]
                    </blockquote>
                </ol>
                ...
                <ol>
                    ...
                    <blockquote><?php _e("eg.", "wp-ultra-simple-paypal-shopping-cart"); ?>
                        [wp_cart:<?php _e("Test Product", "wp-ultra-simple-paypal-shopping-cart"); ?>:price:15:var1[Size|Small|Medium|Large]:end]
                    </blockquote>
                </ol>
                ...
                <ol>
                    ...
                    <blockquote><?php _e("eg.", "wp-ultra-simple-paypal-shopping-cart"); ?>
                        [wp_cart:<?php _e("Test Product", "wp-ultra-simple-paypal-shopping-cart"); ?>:price:15:shipping:2:var1[<?php _e("Size|Small|Medium|Large", "wp-ultra-simple-paypal-shopping-cart"); ?>]:end]
                    </blockquote>
                </ol>
                ...
                <ol>
                    ...
                    <blockquote><?php _e("eg.", "wp-ultra-simple-paypal-shopping-cart"); ?>
                        [wp_cart:<?php _e("Test Product", "wp-ultra-simple-paypal-shopping-cart"); ?>:price:15:shipping:2:var1[<?php _e("Size|Small|Medium|Large", "wp-ultra-simple-paypal-shopping-cart"); ?>]:var2[<?php _e("Color|Red|Green", "wp-ultra-simple-paypal-shopping-cart"); ?>]:end]
                    </blockquote>
                </ol>
            ...
            <p>
            <h4><?php _e("3.a To add the shopping cart to a post or page (eg. checkout page) simply add the shortcode", "wp-ultra-simple-paypal-shopping-cart"); ?>
            </h4>
            <blockquote>
                <blockquote>
                    <?php _e("To display checkout to a post or page, simply add the shortcode", "wp-ultra-simple-paypal-shopping-cart"); ?>
            ...
            <h4><?php _e('3.b If you want (need) to use the 3 steps cart process do following :', "wp-ultra-simple-paypal-shopping-cart"); ?>
            </h4>

            <blockquote>
                <blockquote>
                    <ol>
                        <li><?php _e('Create a page with the shortcode', "wp-ultra-simple-paypal-shopping-cart"); ?>
                        ...
                        <li><?php _e('Create a page with your form (<a href="https://wordpress.org/plugins/contact-form-7/" target="_blank">Contact form 7</a> is the current better choice) and do the following configuration to your form:', "wp-ultra-simple-paypal-shopping-cart"); ?>
                            <ol>
                                ...
                                <li><?php _e('Scroll down and go to "Additional Settings" text area', "wp-ultra-simple-paypal-shopping-cart"); ?>,
                                </li>
                                <li><?php _e('Paste : on_sent_ok: "location = \'http://example.com/mycart\';" (replace http://example.com/mycart by your own URL) ', "wp-ultra-simple-paypal-shopping-cart"); ?>,
                                </li>
                                <li><?php _e("And create http://example.com/mycart page if not existing, plus past following shortcode inside it", "wp-ultra-simple-paypal-shopping-cart"); ?>
            ...
            <p>
            <h4><?php _e('4. Good selling ! If you need help, whether it’s a plugin that causing issues, a theme, or just needed help with styling your site or', "wp-ultra-simple-paypal-shopping-cart"); ?>
                <strong>WPUSPSC</strong> <?php _e('…We can help!', "wp-ultra-simple-paypal-shopping-cart"); ?>
            </h4>

            <blockquote>
                <blockquote>
                    <em><strong><a title="Live Ultra Prod Support"
                                href="https://www.ultra-prod.com/live-ultra-prod-staff-support/"
                                target="_blank"><?php _e("Live Support", "wp-ultra-simple-paypal-shopping-cart"); ?></a></strong></em>
                    <?php _e("for all your needs on ", "wp-ultra-simple-paypal-shopping-cart"); ?>
                    <em><strong>WordPress</strong></em> <?php _e("or", "wp-ultra-simple-paypal-shopping-cart"); ?>
                    <strong><em>Prestashop</em></strong>!
                    <?php _e("Support provided by Ultra Prod Staff.", "wp-ultra-simple-paypal-shopping-cart"); ?>
                </blockquote>
            </blockquote>
...
<p>' . __("If the answer is yes, please ask it on ", "wp-ultra-simple-paypal-shopping-cart") . '<a target="_blank" href="https://www.ultra-prod.com/developpement-support/">' . __("this Forum thread", "wp-ultra-simple-paypal-shopping-cart") . '</a><p>
    ...
    <div id="tabs-5">
        <h2>
            ...
            <?php _e("WP Ultra Simple Shopping Cart Read ME", "wp-ultra-simple-paypal-shopping-cart"); ?>
        </h2>
        <div class="content">
            <pre>
    ...
    <div id="tabs-6">
        <h2>
            <div id="icon-edit-comments" class="icon32"></div>
            <?php _e("WP Ultra Simple Shopping Cart Support", "wp-ultra-simple-paypal-shopping-cart"); ?>
        </h2>
        <div class="content">
            <h4><?php _e("Do you need support or new features?", "wp-ultra-simple-paypal-shopping-cart") ?></h4>
            <p><?php _e("Just ask on", "wp-ultra-simple-paypal-shopping-cart") ?> <a target="_blank"
                    href="https://www.ultra-prod.com/developpement-support/"><?php _e("WUSPSC Forum", "wp-ultra-simple-paypal-shopping-cart") ?></a>.
            <p>

            <h4><?php _e("Do you need quick and direct support?", "wp-ultra-simple-paypal-shopping-cart") ?></h4>
            <p><?php _e("We can provide you \"Live Support\" for all your WordPress or Prestashop needs!", "wp-ultra-simple-paypal-shopping-cart") ?>
                <a target="_blank"
                    href="https://www.ultra-prod.com/live-ultra-prod-staff-support/"><?php _e("click on UP Live Support", "wp-ultra-simple-paypal-shopping-cart") ?></a>.
                <?php _e("Support provided by Ultra Prod Staff.", "wp-ultra-simple-paypal-shopping-cart") ?>
            <p>

            <h4><?php _e("Do you like the WP Ultra Simple Paypal Shopping Cart Plugin?", "wp-ultra-simple-paypal-shopping-cart") ?>
            </h4>
            <p><?php _e("Please", "wp-ultra-simple-paypal-shopping-cart") ?> <a target="_blank"
                    href="https://wordpress.org/plugins/wp-ultra-simple-paypal-shopping-cart/"><?php _e("give it a good rating", "wp-ultra-simple-paypal-shopping-cart") ?></a>
                <?php _e("on Wordpress website", "wp-ultra-simple-paypal-shopping-cart") ?>.</p>
        </div>
    </div>
    ...
    <div id="tabs-2">
        <h2>
            ...
            <?php _e("WP Ultra Simple Shopping Cart Settings", "wp-ultra-simple-paypal-shopping-cart"); ?> v
            <?php echo WUSPSC_VERSION; ?>
        </h2>
...
<td><input type="text" name="cart_validate_url" value="' . $cart_validate_url . '" size="100"><p>' . __("Configure this URL if you like to have a form as step 2, before the final paypal cart (use [validate_wp_shopping_cart] shortcod on th first step cart page). Leave empty if you not need this.", "wp-ultra-simple-paypal-shopping-cart") . '<br/>
	...
	' . __("The customer will be redirected to cart with paypal button after successful form submit", "wp-ultra-simple-paypal-shopping-cart") . '
	</p>
	</td>
	<tr valign="top">
